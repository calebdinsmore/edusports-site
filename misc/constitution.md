...
- For the first two weeks of the regular season, each team will face a division rival.
- For weeks 3 through 11, each team will play a team outside their division (only once per season).
- For weeks 12 and 13, each team will face a division rival for the second time.
...
Therefore, roster sizes will max out at 42 spots.
